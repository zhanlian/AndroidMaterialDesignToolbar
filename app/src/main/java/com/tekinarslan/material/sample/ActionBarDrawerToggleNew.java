 ...
 */
public class ActionBarDrawerToggleNew implements DrawerLayoutNew.DrawerListener {
    

    /**
     * Allows an implementing Activity to return an {@link ActionBarDrawerToggleNew.Delegate} to use
     * with ActionBarDrawerToggleNew.
     */
    ...
    private final DrawerLayoutNew mDrawerLayout;
    ...
    /**
     * Construct a new ActionBarDrawerToggleNew.
     * <p/>
     * <p>The given {@link Activity} will be linked to the specified {@link DrawerLayoutNew} and
     ...
     * @param DrawerLayoutNew              The DrawerLayoutNew to link to the given Activity's ActionBar
     * @param openDrawerContentDescRes  A String resource to describe the "open drawer" action
     *                                  for accessibility
     * @param closeDrawerContentDescRes A String resource to describe the "close drawer" action
     *                                  for accessibility
     */
    public ActionBarDrawerToggleNew(Activity activity, DrawerLayoutNew DrawerLayoutNew,
                                    @StringRes int openDrawerContentDescRes,
                                    @StringRes int closeDrawerContentDescRes) {
        this(activity, null, DrawerLayoutNew, null, openDrawerContentDescRes,
                closeDrawerContentDescRes);
    }

    /**
     * Construct a new ActionBarDrawerToggleNew with a Toolbar.
     * <p/>
     * The given {@link Activity} will be linked to the specified {@link DrawerLayoutNew} and
     ...
     * <p/>
     * Please use {@link #ActionBarDrawerToggleNew(Activity, DrawerLayoutNew, int, int)} if you are
    ...
    public ActionBarDrawerToggleNew(Activity activity, DrawerLayoutNew DrawerLayoutNew,
        ...
        this(activity, toolbar, DrawerLayoutNew, null, openDrawerContentDescRes,
                closeDrawerContentDescRes);
    }
     ...
     * animation.
     */
    <T extends Drawable & DrawerToggle> ActionBarDrawerToggleNew(Activity activity, Toolbar toolbar,
                                                                 DrawerLayoutNew DrawerLayoutNew, T slider,
    ...
    /**
     * Synchronize the state of the drawer indicator/affordance with the linked DrawerLayoutNew.
     * <p/>
     ...
     * the DrawerLayoutNew's instance state has been restored, and any other time when the state
     * may have diverged in such a way that the ActionBarDrawerToggleNew was not notified.
    ...
    /**
     * {@link DrawerLayoutNew.DrawerListener} callback method. If you do not use your
     * ActionBarDrawerToggleNew instance directly as your DrawerLayoutNew's listener, you should call
    ...
    void setActionBarUpIndicator(Drawable upDrawable, int contentDescRes) {
        if (!mWarnedForDisplayHomeAsUp && !mActivityImpl.isNavigationVisible()) {
            Log.w("ActionBarDrawerToggleNew", "DrawerToggle may not show up because NavigationIcon"
    ...
    static class DrawerArrowDrawableToggle extends DrawerArrowDrawableNew
    ...
    private static class HoneycombDelegate implements Delegate {
        ...
        ActionBarDrawerToggleHoneycombNew.SetIndicatorInfo mSetIndicatorInfo;
        ...
        public Drawable getThemeUpIndicator() {
            return ActionBarDrawerToggleHoneycombNew.getThemeUpIndicator(mActivity);
        }
        ...
        public void setActionBarUpIndicator(Drawable themeImage, int contentDescRes) {
            ...
            mSetIndicatorInfo = (ActionBarDrawerToggleHoneycombNew.SetIndicatorInfo) ActionBarDrawerToggleHoneycombNew.setActionBarUpIndicator(
        ...
        public void setActionBarDescription(int contentDescRes) {
            mSetIndicatorInfo = (ActionBarDrawerToggleHoneycombNew.SetIndicatorInfo) ActionBarDrawerToggleHoneycombNew.setActionBarDescription(
